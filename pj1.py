...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.width = width
        self.height = height
        self.tile = [dirt_amount] * (self.width * self.height)
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        loc = math.floor(pos.y) * self.width + math.floor(pos.x)
        self.tile[loc] = max(0, self.tile[loc] - capacity)
    ...
    def is_tile_cleaned(self, m, n):
        ...
        Note: The tile is considered clean only when the amount of dirt on this
              tile is 0.
        """
        return self.tile[m + n * self.width] == 0
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        return sum(x == 0 for x in self.tile)
    ...
    def get_dirt_amount(self, m, n):
        ...
        Returns: an integer
        """
        return self.tile[m + n * self.width]
...
class EmptyRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        Returns: True if pos is in the room, False otherwise.
        """
        return (math.floor(pos.get_x()) < self.width) and (pos.get_x() >= 0) and (math.floor(pos.get_y()) < self.height) and (pos.get_y() >= 0)
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        """
        return not self.is_position_furnished(pos) and (math.floor(pos.get_x()) < self.width) and (pos.get_x() >= 0) and (math.floor(pos.get_y()) < self.height) and (pos.get_y() >= 0)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for i in range(0, num_trials):
        ...
        count = 0
        while room.get_num_cleaned_tiles() * 1.0 / room.get_num_tiles() < min_coverage:
            count += 1
            for robot in robots:
                robot.update_position_and_clean()
        record[i] = count
    return sum(record)/num_trials
